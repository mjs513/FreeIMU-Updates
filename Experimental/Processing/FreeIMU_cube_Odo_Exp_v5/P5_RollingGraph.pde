...
////////////////////////////////////////////
class GraphWin extends PApplet {
  ...
  */
  ...
  void setup() {
    ...
    //cp5a.setControlFont(p, 12);

    CheckBox checkbox;
    
    cp5a.addTextlabel("label")
    ...
    cp5a.addSlider("Min")
       ...
       //.setPosition(290,10);
       .setPosition(370,10);
    //cp5a.addSlider("def").plugTo(parent,"def").setRange(0, 255).setPosition(10,30);
    
    cp5a.addTextlabel("label1")
       .setText("Set Attit. Range: ")
       .setPosition(10,40)
       .setColorValue(0xffffff00)
       .setFont(createFont("Arial bold", 14));   
    cp5a.addSlider("Max Ang")
       .setSize(100,20)
       .setRange(0, 180)
       .setNumberOfTickMarks(32)
       .setPosition(140,40);
    cp5a.addSlider("Min Ang")
       .setSize(100,20)
       .setRange(-180, 0)
       .setNumberOfTickMarks(32)
       .setPosition(310,40);
         
    cp5a.addBang("Set Config")
       //.setPosition(175, 80)
       .setPosition(280, 160)
       .setSize(100, 20)
       .getCaptionLabel().align(ControlP5.CENTER, ControlP5.CENTER);  

     cp5a.addCheckBox("checkBox")
                .setPosition(100, 120)
  ...
  void keyPressed() {
    if (key==' ') {
      cp5a.get(CheckBox.class, "checkBox").deactivateAll();
    } 
  }
  
  void controlEvent(ControlEvent theEvent) {
    
    if (theEvent.isFrom("Set Config")) { 
      //println(cp5a.get(CheckBox.class, "checkBox").getArrayValue());
      //println(cp5a.get(CheckBox.class, "checkBox").getArrayValue().length);
      cp5a.hide();
      ...
      for (int i=0;i<cp5a.get(CheckBox.class, "checkBox").getArrayValue().length;i++) {
        int n = (int)cp5a.get(CheckBox.class, "checkBox").getArrayValue()[i];
        if(n == 1){
          switch (i) {
            case 0:
              g.addTrace(r);
      ...
      g.setYAxisMax(cp5a.get(Slider.class, "Max").getValue());
      g.setYAxisMin(cp5a.get(Slider.class, "Min").getValue());
      g.setYAxisTickSpacing((cp5a.get(Slider.class, "Max").getValue()-cp5a.get(Slider.class, "Min").getValue())/10);
      ...
      g1.setYAxisMax(cp5a.get(Slider.class, "Max Ang").getValue());
      g1.setYAxisMin(cp5a.get(Slider.class, "Min Ang").getValue());
      g1.setYAxisTickSpacing((cp5a.get(Slider.class, "Max Ang").getValue()-cp5a.get(Slider.class, "Min Ang").getValue())/10);
