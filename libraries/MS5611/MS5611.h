...
enum osr_t
{
    OSR_ULTRA_HIGH = 12,        // 10 millis    4096 samples
    OSR_HIGH       = 11,        //  5 millis	2048 samples
    OSR_STANDARD   = 10,        //  3 millis	1024 samples
    OSR_LOW        = 9,         //  2 millis	 512 samples
    OSR_ULTRA_LOW  = 8          //  1 millis    Default = backwards compatible   256 samples
};
