...
update with fixes 5/2023 - mjs513
"""
...
const int acc_scale_x = %f;
const int acc_scale_y = %f;
const int acc_scale_z = %f;

const int magn_off_x = %d;
const int magn_off_y = %d;
const int magn_off_z = %d;
const int magn_scale_x = %f;
const int magn_scale_y = %f;
const int magn_scale_z = %f;
"""
