...
class Ui_FreeIMUCal(object):
    def setupUi(self, FreeIMUCal):
        ...
        self.gridLayout.addWidget(self.calibrateButton, 0, 11, 1, 1)
        self.label = QtGui.QLabel(self.gridLayoutWidget)
        self.label.setObjectName(_fromUtf8("label"))
        self.gridLayout.addWidget(self.label, 0, 0, 1, 1)
        self.setBaudRateComboBox = QtGui.QComboBox(self.gridLayoutWidget)
        ...
        self.gridLayout.addWidget(self.calAlgorithmComboBox, 0, 10, 1, 1)		
        self.gridLayout.addWidget(self.setBaudRateComboBox, 0, 5, 1, 1)
